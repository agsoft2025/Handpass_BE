...
router.post("/device/getAll", authenticate, deviceController.fetchAllConnectDevices);
...
router.put('/connect/:id', authenticate, authorizeRoles('admin', 'superadmin'), deviceController.updateDevice)
router.get('/connect/:id', authenticate, deviceController.fetchSingleDevice)
router.delete('/connect/:id', authenticate, authorizeRoles('admin', 'superadmin'), deviceController.deleteDevice)
